...
public class RSSContentHandler extends DefaultHandler {
	...
	private ArrayList currentComments = new ArrayList();

	private ArrayList currentFixVersions = new ArrayList();

	private ArrayList currentReportedVersions = new ArrayList();

	private ArrayList currentComponents = new ArrayList();
	...
	public void endElement(String uri, String localName, String qName) throws SAXException {
		...
		case IN_ITEM:
			if (CHANNEL.equals(localName)) {
				...
				currentIssue.setReportedVersions((Version[]) currentReportedVersions
						.toArray(new Version[currentReportedVersions.size()]));
				currentIssue.setFixVersions((Version[]) currentFixVersions.toArray(new Version[currentFixVersions
						.size()]));
				currentIssue.setComponents((Component[]) currentComponents.toArray(new Component[currentComponents
						.size()]));
				currentIssue.setComments((Comment[]) currentComments.toArray(new Comment[currentComments.size()]));
