...
import org.eclipse.mylar.jira.core.internal.DebugManager;
...
import org.eclipse.mylar.jira.core.internal.service.web.JiraWebSessionCallback;
...
public abstract class RSSFeedProcessorCallback implements JiraWebSessionCallback {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.eclipse.mylar.jira.core.internal.service.web.JiraWebSessionCallback#execute(org.apache.commons.httpclient.HttpClient,
	 *      org.eclipse.mylar.jira.core.internal.service.JiraServer)
	 */
	public final void execute(HttpClient client, JiraServer server) {
		...
		try {
			...
			int status = client.executeMethod(rssRequest);
			...
			if (!isXMLOrRSS(rssRequest)) {
				...
				status = client.executeMethod(rssRequest);
