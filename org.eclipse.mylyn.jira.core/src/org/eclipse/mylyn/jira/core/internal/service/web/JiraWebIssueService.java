 ...
 *******************************************************************************/
package org.eclipse.mylar.jira.core.internal.service.web;
...
import org.eclipse.mylar.jira.core.internal.service.web.rss.RSSFeedProcessorCallback;
...
public class JiraWebIssueService {
	...
	public void attachFile(final Issue issue, final String comment, final String filename, final byte[] contents,
		...
		s.doInSession(new JiraWebSessionCallback() {
			 ...
			 * (non-Javadoc)
			 * 
			 * @see org.eclipse.mylar.jira.core.internal.service.web.JiraWebSessionCallback#execute(org.apache.commons.httpclient.HttpClient,org.eclipse.mylar.jira.core.internal.service.JiraServer)
			 */
			public void execute(HttpClient client, JiraServer server) {
				...
				post.setRequestEntity(new MultipartRequestEntity((Part[]) parts.toArray(new Part[parts.size()]), post
						.getParams()));
		...
		s.doInSession(new JiraWebSessionCallback() {
			...
			public void execute(HttpClient client, JiraServer server) {
				...
				try {
					...
					post.setRequestEntity(new MultipartRequestEntity((Part[]) parts.toArray(new Part[parts.size()]),
							post.getParams()));
