...
public class CimFieldsInfoMapJsonParserTest {
    ...
    @Test
    public void testParseWithArrayOfArrayAllowedValuesBug() throws JSONException, URISyntaxException {
    ...
    @Test
    public void testParseWithAllowedValuesForSecurityLevels() throws JSONException, URISyntaxException {
        final CimFieldsInfoMapJsonParser parser = new CimFieldsInfoMapJsonParser();
        final Map<String, CimFieldInfo> fieldsInfo = parser.parse(
    ...
    @Test
    public void testParseWithAllowedValuesForResolution() throws JSONException, URISyntaxException {
        final CimFieldsInfoMapJsonParser parser = new CimFieldsInfoMapJsonParser();
        final Map<String, CimFieldInfo> fieldsInfo = parser.parse(
                getJsonObjectFromResource("/json/createmeta/fieldsinfo/valid-with-all-issue-types.json")
                );
    ...
    @Test
    public void testParseWithArrayOfArrayAllowedValuesBugFixed() throws JSONException, URISyntaxException {
        final CimFieldsInfoMapJsonParser parser = new CimFieldsInfoMapJsonParser();
        final Map<String, CimFieldInfo> fieldsInfo = parser.parse(
    ...
    @Test
    public void testParseWithAllIssueTypesShouldReturnFieldsWithNames() throws JSONException, URISyntaxException {
        final CimFieldsInfoMapJsonParser parser = new CimFieldsInfoMapJsonParser();
        final Map<String, CimFieldInfo> fieldsInfo = parser.parse(
                getJsonObjectFromResource("/json/createmeta/fieldsinfo/valid-with-all-issue-types.json")
                );
