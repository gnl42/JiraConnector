...
/**
 * Constants used in various unit tests. All constants including full URIs are
 * usually useless in integration tests though, as during integration tests we
 * may be testing against a JIRA running on a different port and with a
 * different web context
 *
 * @since v0.1
 */
public class TestConstants {
    ...
    // USER1_BASIC_DEPRECATED is deprecated - all tests that use this constant
    // should be reviewed (JIRA now returns more info than we test)
    public static final BasicUser USER1_BASIC_DEPRECATED = new BasicUser(toUri("http://localhost:8090/jira/rest/api/latest/user?username=wseliga"),
            USER1_USERNAME, "Wojciech Seliga", null, null, false);
    ...
    // USER_ADMIN_DEPRECATED this is deprecated - all tests that use this constant
    // should be reviewed (JIRA now returns more info than we test)
    ...
    public static final Version VERSION_1 = new Version(toUri("http://localhost:8090/jira/rest/api/latest/version/10001"), 10001L, "1", "initial version",
            false, false, null);

    public static final Version VERSION_1_1 = new Version(toUri("http://localhost:8090/jira/rest/api/latest/version/10000"), 10000L, "1.1", "Some version",
            true, false, TestUtil.toOffsetDateTime("2010-08-25T00:00:00.000+0200"));

    public static final BasicComponent BCOMPONENT_A = new BasicComponent(toUri("http://localhost:8090/jira/rest/api/latest/component/10000"), 10000L,
            "Component A", "this is some description of component A");

    public static final BasicComponent BCOMPONENT_B = new BasicComponent(toUri("http://localhost:8090/jira/rest/api/latest/component/10001"), 10001L,
