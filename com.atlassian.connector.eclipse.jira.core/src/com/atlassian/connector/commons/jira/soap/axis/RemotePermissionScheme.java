...
public class RemotePermissionScheme extends com.atlassian.connector.commons.jira.soap.axis.RemoteScheme
		implements java.io.Serializable {
	private com.atlassian.connector.commons.jira.soap.axis.RemotePermissionMapping[] permissionMappings;
	...
	public RemotePermissionScheme(
			...
			com.atlassian.connector.commons.jira.soap.axis.RemotePermissionMapping[] permissionMappings) {
		super(
				description,
				id,
				name,
	 ...
	 */
	public com.atlassian.connector.commons.jira.soap.axis.RemotePermissionMapping[] getPermissionMappings() {
		return permissionMappings;
	}
	 ...
	 */
	public void setPermissionMappings(com.atlassian.connector.commons.jira.soap.axis.RemotePermissionMapping[] permissionMappings) {
		this.permissionMappings = permissionMappings;
	}
