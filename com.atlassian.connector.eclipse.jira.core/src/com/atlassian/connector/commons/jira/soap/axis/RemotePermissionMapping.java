...
public class RemotePermissionMapping implements java.io.Serializable {
	private com.atlassian.connector.commons.jira.soap.axis.RemotePermission permission;

	private com.atlassian.connector.commons.jira.soap.axis.RemoteEntity[] remoteEntities;

	public RemotePermissionMapping() {
	}

	public RemotePermissionMapping(
			com.atlassian.connector.commons.jira.soap.axis.RemotePermission permission,
			com.atlassian.connector.commons.jira.soap.axis.RemoteEntity[] remoteEntities) {
	 ...
	 * @return permission
	 */
	public com.atlassian.connector.commons.jira.soap.axis.RemotePermission getPermission() {
		return permission;
	}
	 ...
	 * @param permission
	 */
	public void setPermission(com.atlassian.connector.commons.jira.soap.axis.RemotePermission permission) {
		this.permission = permission;
	}
	 ...
	 */
	public com.atlassian.connector.commons.jira.soap.axis.RemoteEntity[] getRemoteEntities() {
		return remoteEntities;
	}
	 ...
	 */
	public void setRemoteEntities(com.atlassian.connector.commons.jira.soap.axis.RemoteEntity[] remoteEntities) {
		this.remoteEntities = remoteEntities;
	}
