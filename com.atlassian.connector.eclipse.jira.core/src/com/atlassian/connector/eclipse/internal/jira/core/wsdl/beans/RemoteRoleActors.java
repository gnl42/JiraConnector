...
public class RemoteRoleActors implements java.io.Serializable {
	private com.atlassian.connector.eclipse.internal.jira.core.wsdl.beans.RemoteProjectRole projectRole;

	private com.atlassian.connector.eclipse.internal.jira.core.wsdl.beans.RemoteRoleActor[] roleActors;

	private com.atlassian.connector.eclipse.internal.jira.core.wsdl.beans.RemoteUser[] users;

	public RemoteRoleActors() {
	}

	public RemoteRoleActors(com.atlassian.connector.eclipse.internal.jira.core.wsdl.beans.RemoteProjectRole projectRole,
	 ...
	 * @return projectRole
	 */
	public com.atlassian.connector.eclipse.internal.jira.core.wsdl.beans.RemoteProjectRole getProjectRole() {
		return projectRole;
	}
	 ...
	 * @param projectRole
	 */
	public void setProjectRole(com.atlassian.connector.eclipse.internal.jira.core.wsdl.beans.RemoteProjectRole projectRole) {
		this.projectRole = projectRole;
	}
	 ...
	 * @return roleActors
	 */
	public com.atlassian.connector.eclipse.internal.jira.core.wsdl.beans.RemoteRoleActor[] getRoleActors() {
		return roleActors;
	}
	 ...
	 * @param roleActors
	 */
	public void setRoleActors(com.atlassian.connector.eclipse.internal.jira.core.wsdl.beans.RemoteRoleActor[] roleActors) {
		this.roleActors = roleActors;
	}
	 ...
	 * @return users
	 */
	public com.atlassian.connector.eclipse.internal.jira.core.wsdl.beans.RemoteUser[] getUsers() {
		return users;
	}
	 ...
	 * @param users
	 */
	public void setUsers(com.atlassian.connector.eclipse.internal.jira.core.wsdl.beans.RemoteUser[] users) {
		this.users = users;
	}
