...
public class RemotePermissionMapping implements java.io.Serializable {
	private com.atlassian.connector.eclipse.internal.jira.core.wsdl.beans.RemotePermission permission;

	private com.atlassian.connector.eclipse.internal.jira.core.wsdl.beans.RemoteEntity[] remoteEntities;

	public RemotePermissionMapping() {
	}

	public RemotePermissionMapping(com.atlassian.connector.eclipse.internal.jira.core.wsdl.beans.RemotePermission permission,
			com.atlassian.connector.eclipse.internal.jira.core.wsdl.beans.RemoteEntity[] remoteEntities) {
	 ...
	 * @return permission
	 */
	public com.atlassian.connector.eclipse.internal.jira.core.wsdl.beans.RemotePermission getPermission() {
		return permission;
	}
	 ...
	 * @param permission
	 */
	public void setPermission(com.atlassian.connector.eclipse.internal.jira.core.wsdl.beans.RemotePermission permission) {
		this.permission = permission;
	}
	 ...
	 */
	public com.atlassian.connector.eclipse.internal.jira.core.wsdl.beans.RemoteEntity[] getRemoteEntities() {
		return remoteEntities;
	}
	 ...
	 */
	public void setRemoteEntities(com.atlassian.connector.eclipse.internal.jira.core.wsdl.beans.RemoteEntity[] remoteEntities) {
		this.remoteEntities = remoteEntities;
	}
