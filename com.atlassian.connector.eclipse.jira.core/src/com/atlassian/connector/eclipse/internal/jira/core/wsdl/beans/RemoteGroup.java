...
public class RemoteGroup extends com.atlassian.connector.eclipse.internal.jira.core.wsdl.beans.RemoteEntity implements
	...
	public RemoteGroup(java.lang.String name, com.atlassian.connector.eclipse.internal.jira.core.wsdl.beans.RemoteUser[] users) {
		this.name = name;
		this.users = users;
	}
