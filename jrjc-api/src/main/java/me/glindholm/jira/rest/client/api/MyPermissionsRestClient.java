...
public interface MyPermissionsRestClient {
     ...
     *                        <ul>
     *                        <li>When no context supplied (null) the project related permissions will
     *                        return true if the user has that permission in ANY project</li>
     *                        <li>If a project context is provided, project related permissions will
     *                        return true if the user has the permissions in the specified project. For
     ...
     *                        issue in that project</li>
     *                        <li>If an issue context is provided, it will return whether or not the
     *                        user has each permission in that specific issue</li>
     *                        </ul>
