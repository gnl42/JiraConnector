 ...
 */
public class AtlassianTeamCorePlugin extends Plugin {

	// The plug-in ID
	public static final String PLUGIN_ID = "com.atlassian.connector.eclipse.team.core";

	// The shared instance
	private static AtlassianTeamCorePlugin plugin;
	 ...
	 */
	public static AtlassianTeamCorePlugin getDefault() {
		return plugin;
	}
