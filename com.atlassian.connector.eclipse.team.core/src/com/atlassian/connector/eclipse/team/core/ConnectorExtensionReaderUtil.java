				...
				for (IConfigurationElement element : elements) {
					if (element.getName().equals(elementName)) {
						try {
							...
							StatusHandler.log(new Status(IStatus.WARNING, AtlassianTeamCorePlugin.PLUGIN_ID,
...
//		try {
		...
		if (!clazz.isInstance(object)) {
			throw new CoreException(new Status(IStatus.WARNING, AtlassianTeamCorePlugin.PLUGIN_ID,
