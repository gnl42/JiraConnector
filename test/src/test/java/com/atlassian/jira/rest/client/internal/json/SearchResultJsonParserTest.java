...
public class SearchResultJsonParserTest {
	...
	public void testParse() throws Exception {
		...
		Assert.assertEquals(new SearchResult(0, 50, 1, issues), searchResult);
	}
	...
	public void testParseMany() throws Exception {
		...
		Assert.assertEquals(9, searchResult.getTotal());
		Assert.assertEquals(8, searchResult.getMaxResults());
		Assert.assertEquals(0, searchResult.getStartIndex());
		Assert.assertEquals(8, Iterables.size(searchResult.getIssues()));
