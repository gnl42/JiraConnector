...
public class WatchersJsonParserTest {
    ...
    public void testParseWatchers() throws JSONException {
        ...
        Assert.assertThat(watcher.getUsers(), IsIterableContainingInAnyOrder.containsInAnyOrder(TestConstants.USER1_BASIC_DEPRECATED, TestConstants.USER_ADMIN_BASIC_DEPRECATED));
