...
public class IntRanges {
    ...
    private static final Comparator<IntRange> COMPARATOR = (o1, o2) -> o1.getMin() - o2.getMin();

    /**
     * @param ranges list cannot be empty. Copy is made here, so you may freely modify the array
     *               afterwards
     */
