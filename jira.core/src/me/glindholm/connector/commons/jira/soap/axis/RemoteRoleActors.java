...
public class RemoteRoleActors implements java.io.Serializable {
	private me.glindholm.connector.commons.jira.soap.axis.RemoteProjectRole projectRole;

	private me.glindholm.connector.commons.jira.soap.axis.RemoteRoleActor[] roleActors;

	private me.glindholm.connector.commons.jira.soap.axis.RemoteUser[] users;

	public RemoteRoleActors() {
	}

	public RemoteRoleActors(
			me.glindholm.connector.commons.jira.soap.axis.RemoteProjectRole projectRole,
			me.glindholm.connector.commons.jira.soap.axis.RemoteRoleActor[] roleActors,
			me.glindholm.connector.commons.jira.soap.axis.RemoteUser[] users) {
	 ...
	 * @return projectRole
	 */
	public me.glindholm.connector.commons.jira.soap.axis.RemoteProjectRole getProjectRole() {
		return projectRole;
	}
	 ...
	 * @param projectRole
	 */
	public void setProjectRole(me.glindholm.connector.commons.jira.soap.axis.RemoteProjectRole projectRole) {
		this.projectRole = projectRole;
	}
	 ...
	 * @return roleActors
	 */
	public me.glindholm.connector.commons.jira.soap.axis.RemoteRoleActor[] getRoleActors() {
		return roleActors;
	}
	 ...
	 * @param roleActors
	 */
	public void setRoleActors(me.glindholm.connector.commons.jira.soap.axis.RemoteRoleActor[] roleActors) {
		this.roleActors = roleActors;
	}
	 ...
	 * @return users
	 */
	public me.glindholm.connector.commons.jira.soap.axis.RemoteUser[] getUsers() {
		return users;
	}
	 ...
	 * @param users
	 */
	public void setUsers(me.glindholm.connector.commons.jira.soap.axis.RemoteUser[] users) {
		this.users = users;
	}
