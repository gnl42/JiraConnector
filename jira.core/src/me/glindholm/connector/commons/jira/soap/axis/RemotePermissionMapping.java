...
public class RemotePermissionMapping implements java.io.Serializable {
	private me.glindholm.connector.commons.jira.soap.axis.RemotePermission permission;

	private me.glindholm.connector.commons.jira.soap.axis.RemoteEntity[] remoteEntities;

	public RemotePermissionMapping() {
	}

	public RemotePermissionMapping(
			me.glindholm.connector.commons.jira.soap.axis.RemotePermission permission,
			me.glindholm.connector.commons.jira.soap.axis.RemoteEntity[] remoteEntities) {
	 ...
	 * @return permission
	 */
	public me.glindholm.connector.commons.jira.soap.axis.RemotePermission getPermission() {
		return permission;
	}
	 ...
	 * @param permission
	 */
	public void setPermission(me.glindholm.connector.commons.jira.soap.axis.RemotePermission permission) {
		this.permission = permission;
	}
	 ...
	 */
	public me.glindholm.connector.commons.jira.soap.axis.RemoteEntity[] getRemoteEntities() {
		return remoteEntities;
	}
	 ...
	 */
	public void setRemoteEntities(me.glindholm.connector.commons.jira.soap.axis.RemoteEntity[] remoteEntities) {
		this.remoteEntities = remoteEntities;
	}
