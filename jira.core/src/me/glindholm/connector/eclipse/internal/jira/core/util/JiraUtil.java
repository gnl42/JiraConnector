...
//	public static final int DEFAULT_MAX_SEARCH_RESULTS = TaskDataCollector.MAX_HITS;
	...
	private static final boolean TRACE_ENABLED = Boolean.valueOf(Platform.getDebugOption("me.glindholm.connector.eclipse.jira.core/debug/repository")); //$NON-NLS-1$
