...
public class RemoteGroup extends me.glindholm.connector.eclipse.internal.jira.core.wsdl.beans.RemoteEntity implements
	...
	public RemoteGroup(java.lang.String name, me.glindholm.connector.eclipse.internal.jira.core.wsdl.beans.RemoteUser[] users) {
		this.name = name;
		this.users = users;
	}
