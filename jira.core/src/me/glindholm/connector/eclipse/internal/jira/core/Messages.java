...
public class Messages extends NLS {
    private static final String BUNDLE_NAME = "me.glindholm.connector.eclipse.internal.jira.core.messages"; //$NON-NLS-1$
    ...
    public static String JiraAttribute_Labels;
    ...
    public static String JiraAttribute_Watchers;
    ...
    public static String JiraAttribute_Remotelinks;
