...
package me.glindholm.connector.eclipse.internal.jira.core.service.web;
...
import me.glindholm.connector.eclipse.internal.jira.core.model.WebServerInfo;
...
import me.glindholm.connector.eclipse.internal.jira.core.service.JiraRemoteException;
...
//	}
	...
	private boolean includeCustomField(String key, String value) {
		...
		return !key.startsWith("me.glindholm.jira.toolkit") && //$NON-NLS-1$
				!key.startsWith("me.glindholm.jira.ext.charting"); //$NON-NLS-1$
	}
