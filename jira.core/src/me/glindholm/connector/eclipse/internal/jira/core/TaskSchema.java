...
public class TaskSchema {
    ...
    public static class ExtTaskAttribute<T> {
        ...
        public ExtTaskAttribute(final TaskAttribute attribute) {
    ...
    public static class TaskField<T> {
        ...
        public TaskField(final Class<T> clazz, final String key, final String javaKey, final String label, final String type) {
            this(clazz, key, javaKey, label, type, null);
        }

        public TaskField(final Class<T> clazz, final String key, final String javaKey, final String label, final String type, final Flag firstFlag,
                final Flag... moreFlags) {
            this.clazz = clazz;
            this.key = key;
