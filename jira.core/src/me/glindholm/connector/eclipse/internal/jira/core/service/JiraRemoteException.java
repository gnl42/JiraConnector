...
public class JiraRemoteException extends JiraException {
    ...
    public JiraRemoteException(final String message, final Throwable cause) {
        super(message, cause);
    }

    public JiraRemoteException(final String message) {
        super(message);
    }

    public JiraRemoteException(final Throwable cause) {
        super(cause);
    }
