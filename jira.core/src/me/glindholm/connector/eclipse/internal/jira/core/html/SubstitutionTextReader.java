 ...
 */
/**
 * COPY OF: org.eclipse.jface.internal.text.html.SubstitutionTextReader
 */
public abstract class SubstitutionTextReader extends SingleCharReader {
    ...
    protected SubstitutionTextReader(final Reader reader) {
        fReader = reader;
    ...
    protected int nextChar() throws IOException {
        ...
        if (fReadFromBuffer) {
            final char ch = fBuffer.charAt(fIndex++);
    ...
    public int read() throws IOException {
        ...
        do {
            ...
            while (!fReadFromBuffer) {
                final String s = computeSubstitution(c);
                if (s == null) {
                    break;
                }
                if (s.length() > 0) {
    ...
    protected final void setSkipWhitespace(final boolean state) {
