...
public class ProductVersionUtil implements Serializable {
    ...
    public ProductVersionUtil(final String version) throws IncorrectVersionException {
    ...
    public boolean equals(final Object that) {
        ...
        final ProductVersionUtil thatVersion = (ProductVersionUtil) that;
    ...
    private static class VersionNumber {
        ...
        public VersionNumber(final int major, final int minor, final int micro, final int nano) throws IncorrectVersionException {
            this.major = major;
            this.minor = minor;
            this.micro = micro;
            this.nano = nano;
