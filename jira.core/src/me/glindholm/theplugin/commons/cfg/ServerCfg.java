...
public abstract class ServerCfg implements Server {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof final ServerCfg serverCfg)) {
            return false;
        }
    ...
    /**
     * Returns real clone (deep copy of this object). It intentionally does not use standard Java
     * Cloneable as it sucks terriblyk
     *
     * @return deep copy
     */
