 ...
 * <p>
 * <h3>Synchronization Policy</h3> This cache is synchronized on <code>this</<code>, so while
 * extending this class, ensure that all actions use the same synchronization policy.
 * </p>
 * <p>
 * Inspired by http://blogs.sun.com/swinger/entry/collections_trick_i_lru_cache and
 * href="http://www.source-code.biz
 * </p>
 */
