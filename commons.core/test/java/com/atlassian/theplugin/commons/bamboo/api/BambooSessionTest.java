...
public class BambooSessionTest extends AbstractSessionTest {
    ...
    public void testBuildDetailsMalformedResponse() throws Exception {
        ...
        try {
            ...
            assertEquals("org.jdom2.JDOMException", e.getCause().getClass().getName());
        }
        apiHandler.logout();
    ...
    public void testGetBuildTestResultForBamboo2x6() throws RemoteApiException {
...

        {
            ...
            assertEquals("/PLE/trunk/me.glindholm.connector.eclipse.releng/bamboo.properties",
            ...
            assertEquals("/PLE/trunk/me.glindholm.connector.eclipse.releng/bamboo-release.properties",
...

        {
            ...
            assertEquals("/PLE/trunk/me.glindholm.connector.eclipse.releng/maps/mylyn_e3.5.map",
                    file1.getFileDescriptor().getUrl());
        ...
        final TestDetails test1 = findTestDetails(buildDetails.getSuccessfulTestDetails(), "testChangeCredentials",
                "me.glindholm.connector.eclipse.jira.tests.core.JiraClientFactoryTest");
        assertNotNull(test1);
        ...
        final TestDetails test2 = findTestDetails(buildDetails.getFailedTestDetails(), "testAttachFile",
                "me.glindholm.connector.eclipse.jira.tests.core.JiraTaskAttachmentHandlerTest");
        assertNotNull(test2);
...
//                "me.glindholm.connector.eclipse.internal."
