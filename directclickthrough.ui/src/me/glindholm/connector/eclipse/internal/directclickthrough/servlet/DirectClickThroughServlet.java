package me.glindholm.connector.eclipse.internal.directclickthrough.servlet;
...
import me.glindholm.connector.eclipse.internal.directclickthrough.ui.DirectClickThroughImages;
...
import me.glindholm.theplugin.commons.util.StringUtil;
    ...
    private void handleOpenBuildRequest(final HttpServletRequest req) {
        ...
        try {
            Class<?> corePluginClass = Class
                    .forName("me.glindholm.connector.eclipse.internal.bamboo.core.BambooCorePlugin");
            ...
            Class<?> openBuildJobClass = Class
                    .forName("me.glindholm.connector.eclipse.internal.bamboo.ui.operations.OpenBambooBuildJob");
