...
public class AsynchronousComponentRestClient extends AbstractAsynchronousRestClient implements ComponentRestClient {
    ...
    public AsynchronousComponentRestClient(final URI baseUri, final DisposableHttpClient client) throws URISyntaxException {
        super(client);
        componentUri = new UriBuilder(baseUri).appendPath("component").build();
    }

    @Override
    public CompletableFuture<Component> getComponent(final URI componentUri) {
        return getAndParse(componentUri, componentJsonParser);
    }

    @Override
    public CompletableFuture<Component> createComponent(final String projectKey, final ComponentInput componentInput) {
    ...
    @Override
    public CompletableFuture<Component> updateComponent(final URI componentUri, final ComponentInput componentInput) {
    ...
    @Override
    public CompletableFuture<Void> removeComponent(final URI componentUri, @Nullable final URI moveIssueToComponentUri) throws URISyntaxException {
    ...
    @Override
    public CompletableFuture<Integer> getComponentRelatedIssuesCount(final URI componentUri) throws URISyntaxException {
