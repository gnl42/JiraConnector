...
public class BambooBuildViewerComparatorTest extends TestCase {
	...
	public void testCompareViewerObjectObject() {
		...
		BambooBuildAdapter build1 = new BambooBuildAdapter(createBambooBuild("plan1", sd, BuildStatus.SUCCESS));
		BambooBuildAdapter build2 = new BambooBuildAdapter(createBambooBuild("plan2", sd, BuildStatus.SUCCESS));
		BambooBuildAdapter build3 = new BambooBuildAdapter(createBambooBuild("plan2", sd, BuildStatus.SUCCESS));
		BambooBuildAdapter build4 = new BambooBuildAdapter(createBambooBuild("plan1", sd, BuildStatus.FAILURE));
		BambooBuildAdapter build5 = new BambooBuildAdapter(createBambooBuild("plan2", sd, BuildStatus.FAILURE));
		BambooBuildAdapter build6 = new BambooBuildAdapter(createBambooBuild("plan2", sd, BuildStatus.FAILURE));
		BambooBuildAdapter build7 = new BambooBuildAdapter(createBambooBuild("plan1", sd, BuildStatus.UNKNOWN));
		BambooBuildAdapter build8 = new BambooBuildAdapter(createBambooBuild("plan2", sd, BuildStatus.UNKNOWN));
