...
package com.atlassian.connector.eclipse.internal.subclipse.ui.actions;

import com.atlassian.connector.eclipse.internal.subclipse.ui.wizards.CreatePreCommitReviewWizard;
 ...
 * 
 */
public class CreatePreCommitReviewAction extends WorkbenchWindowAction {
	...
	public void execute(IAction action) throws InvocationTargetException, InterruptedException {
		...
		if (modifiedResources == null || modifiedResources.length == 0) {
			MessageDialog.openInformation(getShell(), Policy.bind("GenerateSVNDiff.title"),
		...
		CreatePreCommitReviewWizard wizard = new CreatePreCommitReviewWizard(
				new StructuredSelection(modifiedResources), unaddedResources, statusMap);
		wizard.setWindowTitle(title);
		wizard.setSelectedResources(getSelectedResources());
		WizardDialog dialog = new WizardDialogWithPersistedLocation(getShell(), wizard, "CreatePreCommitReviewWizard"); //$NON-NLS-1$
