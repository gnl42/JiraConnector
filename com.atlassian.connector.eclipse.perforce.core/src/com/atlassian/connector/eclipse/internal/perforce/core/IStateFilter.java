...
public interface IStateFilter {
	...
	public abstract class AbstractStateFilter implements IStateFilter {
		public boolean accept(IP4Resource resource) {
			return resource instanceof IP4File && FileUtility.isManagedByPerforce(((IP4File)resource).getLocalFileForLocation()) 
				&& this.acceptImpl(resource, ((IP4File)resource).getLocalFileForLocation(), ((IP4File)resource).getStatus());
		}
		...
		public boolean allowsRecursion(IP4Resource resource) {
			return resource instanceof IP4File 
				...
				&& this.allowsRecursionImpl(null, ((IP4File)resource).getLocalFileForLocation(), ((IP4File)resource).getStatus());
		}
		public boolean allowsRecursion(IResource resource, FileSpecOpStatus state) {
			return state != null 
				&& FileUtility.isManagedByPerforce(resource.getProject())
	...
	public static final IStateFilter SF_IGNORED = SF_ALL;
