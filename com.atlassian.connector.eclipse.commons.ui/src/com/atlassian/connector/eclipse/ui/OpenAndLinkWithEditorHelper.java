 ...
 * 
 * @since 3.5
 * @deprecated This class was copied from Eclipse 3.5, remove it and use one from org.eclipse.ui when Eclipse 3.4
 *             support is dropped.
 */
@Deprecated
public abstract class OpenAndLinkWithEditorHelper {
	 ...
	 *            the viewer's selection
	 * @param activate
	 *            <code>true</code> if the editor should be activated, <code>false</code> otherwise
	 * @since 3.5
	 */
	protected abstract void open(ISelection selection, boolean activate);

	/**
	 * Tells to link the given selection to the editor that is open on the given selection but does nothing if no
	 * matching editor can be found.
	 * <p>
	 * The common implementation brings that editor to front but more advanced implementations may also select the given
