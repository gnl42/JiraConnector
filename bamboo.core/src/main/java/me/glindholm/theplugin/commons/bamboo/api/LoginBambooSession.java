...
public class LoginBambooSession extends AbstractHttpSession implements ProductSession {
	 ...
	 * {@link me.glindholm.theplugin.commons.remoteapi.RemoteApiLoginFailedException} is actually thrown. This may be
	 ...
	 * @param aPassword
	 *            for username
	 * @throws me.glindholm.theplugin.commons.remoteapi.RemoteApiLoginException
