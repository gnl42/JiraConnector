...
public class RemoteServerInfo implements java.io.Serializable {
	...
	private com.atlassian.connector.commons.jira.soap.axis.RemoteTimeInfo serverTime;
	...
	public RemoteServerInfo(
			...
			com.atlassian.connector.commons.jira.soap.axis.RemoteTimeInfo serverTime,
	 ...
	 * @return serverTime
	 */
	public com.atlassian.connector.commons.jira.soap.axis.RemoteTimeInfo getServerTime() {
		return serverTime;
	}
	 ...
	 * @param serverTime
	 */
	public void setServerTime(com.atlassian.connector.commons.jira.soap.axis.RemoteTimeInfo serverTime) {
		this.serverTime = serverTime;
	}
