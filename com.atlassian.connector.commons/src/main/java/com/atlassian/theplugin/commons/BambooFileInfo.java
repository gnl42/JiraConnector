...
/**
 * Created by IntelliJ IDEA. User: lguminski Date: Jul 15, 2008 Time: 12:21:36 AM To change this template use File | Settings |
 * File Templates.
 */
public class BambooFileInfo implements VersionedFileInfo {
	...
	public BambooFileInfo(String file, String revision) {
		this(new VersionedVirtualFile(file, revision));
	}
