...
public class BambooUtilTest extends TestCase {
	...
	/**
	 * Test method for
	 * {@link me.glindholm.connector.eclipse.internal.bamboo.core.BambooUtil#setSubcribedPlans(org.eclipse.mylyn.tasks.core.TaskRepository, java.util.Collection)}
	 * .
	 */
	public void testSetAndGetSubcribedPlans() {
		...
		assertEquals(plans.iterator().next(),
				new SubscribedPlan(repo.getProperty("me.glindholm.connector.eclipse.bamboo.subscribedPlans")
						.substring(0, 3)));
	}

	/**
	 * Test method for
	 * {@link me.glindholm.connector.eclipse.internal.bamboo.core.BambooUtil#isUseFavourites(org.eclipse.mylyn.tasks.core.TaskRepository)}
	 * .
	 */
