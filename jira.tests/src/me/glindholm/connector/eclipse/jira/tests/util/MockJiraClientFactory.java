...
import me.glindholm.connector.eclipse.internal.jira.core.IJiraClientFactory;
...
public class MockJiraClientFactory implements IJiraClientFactory {
	...
	public MockJiraClientFactory(final JiraClient client) {
		this.client = client;
	}

	@Override
	public JiraClient getJiraClient(final TaskRepository repository) {
		return client;
	}
