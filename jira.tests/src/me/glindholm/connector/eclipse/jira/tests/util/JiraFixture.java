...
public class JiraFixture extends TestFixture {
	...
	private static final String getServerUrl(final String version) {
	...
	public static final JiraFixture[] ALL = { ENTERPRISE_3_13, ENTERPRISE_4_0, SNAPSHOT };
	...
	public static JiraFixture current(final JiraFixture fixture) {
		if (current == null) {
			fixture.activate();
		}
		return current;
	...
	public JiraFixture(final String url, final String version, final String buildNumber, final String info) {
	...
	public JiraClient client(final PrivilegeLevel level) throws Exception {
		final var client = new JiraClient(location(level));
