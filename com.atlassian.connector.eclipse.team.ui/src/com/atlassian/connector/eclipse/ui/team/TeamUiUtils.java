...
public final class TeamUiUtils {
	...
	public static DefaultTeamUiResourceConnector defaultConnector = new DefaultTeamUiResourceConnector();
	...
	public static void openCompareEditor(String repoUrl, String filePath, String otherRevisionFilePath,
		...
		try {
			...
			TeamUiMessageUtils.openUnableToCompareErrorMessage(repoUrl, filePath, oldRevisionString, newRevisionString, e);
		}
	}
