...
/**
 * The com.atlassian.jira.rest.client handling issue resources.
 *
 * @since 0.1
 */
public interface IssueRestClient {
	 ...
	 * @since com.atlassian.jira.rest.client 1.0, server 5.0
	 */
     ...
     * @throws RestClientException in case of problems (connectivity, malformed messages, invalid argument, etc.)
     * @since com.atlassian.jira.rest.client 1.1, server 6.0
     */
	 ...
	 * @since com.atlassian.jira.rest.client 0.2, server 4.3
	 */
