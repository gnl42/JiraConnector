...
/**
 * The com.atlassian.jira.rest.client.api handling search REST resource
 *
 * @since 2.0 com.atlassian.jira.rest.client.api, 4.3 server
 */
public interface SearchRestClient {
	/**
	 * Performs a JQL search and returns issues matching the query
	 *
	 * @param jql a valid JQL query (will be properly encoded by JIRA com.atlassian.jira.rest.client.api). Restricted JQL characters (like '/') must be properly escaped.
