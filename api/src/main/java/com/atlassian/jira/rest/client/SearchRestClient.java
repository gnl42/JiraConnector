...
/**
 * The com.atlassian.jira.rest.client handling search REST resource
 *
 * @since 2.0 com.atlassian.jira.rest.client, 4.3 server
 */
public interface SearchRestClient {
	/**
	 * Performs a JQL search and returns issues matching the query
	 *
	 * @param jql a valid JQL query (will be properly encoded by JIRA com.atlassian.jira.rest.client). Restricted JQL characters (like '/') must be properly escaped.
