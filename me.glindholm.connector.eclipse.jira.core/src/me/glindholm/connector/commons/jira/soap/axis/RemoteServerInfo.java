...
public class RemoteServerInfo implements java.io.Serializable {
	...
	private me.glindholm.connector.commons.jira.soap.axis.RemoteTimeInfo serverTime;
	...
	public RemoteServerInfo(
			...
			me.glindholm.connector.commons.jira.soap.axis.RemoteTimeInfo serverTime,
	 ...
	 * @return serverTime
	 */
	public me.glindholm.connector.commons.jira.soap.axis.RemoteTimeInfo getServerTime() {
		return serverTime;
	}
	 ...
	 * @param serverTime
	 */
	public void setServerTime(me.glindholm.connector.commons.jira.soap.axis.RemoteTimeInfo serverTime) {
		this.serverTime = serverTime;
	}
