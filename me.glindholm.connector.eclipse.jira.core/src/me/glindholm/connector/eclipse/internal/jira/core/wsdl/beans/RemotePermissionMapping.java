...
public class RemotePermissionMapping implements java.io.Serializable {
	private me.glindholm.connector.eclipse.internal.jira.core.wsdl.beans.RemotePermission permission;

	private me.glindholm.connector.eclipse.internal.jira.core.wsdl.beans.RemoteEntity[] remoteEntities;

	public RemotePermissionMapping() {
	}

	public RemotePermissionMapping(me.glindholm.connector.eclipse.internal.jira.core.wsdl.beans.RemotePermission permission,
			me.glindholm.connector.eclipse.internal.jira.core.wsdl.beans.RemoteEntity[] remoteEntities) {
	 ...
	 * @return permission
	 */
	public me.glindholm.connector.eclipse.internal.jira.core.wsdl.beans.RemotePermission getPermission() {
		return permission;
	}
	 ...
	 * @param permission
	 */
	public void setPermission(me.glindholm.connector.eclipse.internal.jira.core.wsdl.beans.RemotePermission permission) {
		this.permission = permission;
	}
	 ...
	 */
	public me.glindholm.connector.eclipse.internal.jira.core.wsdl.beans.RemoteEntity[] getRemoteEntities() {
		return remoteEntities;
	}
	 ...
	 */
	public void setRemoteEntities(me.glindholm.connector.eclipse.internal.jira.core.wsdl.beans.RemoteEntity[] remoteEntities) {
		this.remoteEntities = remoteEntities;
	}
