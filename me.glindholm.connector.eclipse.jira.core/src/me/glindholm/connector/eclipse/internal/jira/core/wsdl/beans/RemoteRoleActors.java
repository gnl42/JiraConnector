...
public class RemoteRoleActors implements java.io.Serializable {
	private me.glindholm.connector.eclipse.internal.jira.core.wsdl.beans.RemoteProjectRole projectRole;

	private me.glindholm.connector.eclipse.internal.jira.core.wsdl.beans.RemoteRoleActor[] roleActors;

	private me.glindholm.connector.eclipse.internal.jira.core.wsdl.beans.RemoteUser[] users;

	public RemoteRoleActors() {
	}

	public RemoteRoleActors(me.glindholm.connector.eclipse.internal.jira.core.wsdl.beans.RemoteProjectRole projectRole,
			me.glindholm.connector.eclipse.internal.jira.core.wsdl.beans.RemoteRoleActor[] roleActors,
			me.glindholm.connector.eclipse.internal.jira.core.wsdl.beans.RemoteUser[] users) {
	 ...
	 * @return projectRole
	 */
	public me.glindholm.connector.eclipse.internal.jira.core.wsdl.beans.RemoteProjectRole getProjectRole() {
		return projectRole;
	}
	 ...
	 * @param projectRole
	 */
	public void setProjectRole(me.glindholm.connector.eclipse.internal.jira.core.wsdl.beans.RemoteProjectRole projectRole) {
		this.projectRole = projectRole;
	}
	 ...
	 * @return roleActors
	 */
	public me.glindholm.connector.eclipse.internal.jira.core.wsdl.beans.RemoteRoleActor[] getRoleActors() {
		return roleActors;
	}
	 ...
	 * @param roleActors
	 */
	public void setRoleActors(me.glindholm.connector.eclipse.internal.jira.core.wsdl.beans.RemoteRoleActor[] roleActors) {
		this.roleActors = roleActors;
	}
	 ...
	 * @return users
	 */
	public me.glindholm.connector.eclipse.internal.jira.core.wsdl.beans.RemoteUser[] getUsers() {
		return users;
	}
	 ...
	 * @param users
	 */
	public void setUsers(me.glindholm.connector.eclipse.internal.jira.core.wsdl.beans.RemoteUser[] users) {
		this.users = users;
	}
