...
import me.glindholm.connector.eclipse.internal.jira.ui.editor.JiraEditorUtil;
import me.glindholm.connector.eclipse.internal.jira.ui.editor.Messages;
...
public class LogJiraTimeDialog extends MessageDialog {
    ...
    public LogJiraTimeDialog(final Shell parentShell, final TaskData taskData, final ITask iTask, final long seconds) {
    ...
    private void createTimeComponents(final Composite composite) {
        ...
        final String wdhmTime = JiraUtil.getTimeFormat(repository).format(workDoneAmountInSeconds);
        ...
        final GridData descGD = new GridData();
    ...
    protected void validateSettings() {
        ...
        final JiraTimeFormat formatter = JiraUtil.getTimeFormat(repository);
    ...
    private void createDisableTimeTrackingLink(final Composite composite) {
        ...
        link.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(final SelectionEvent e) {
                ...
                if (prefDialog != null) {
                    ...
                    final String message = Messages.LogJiraTimeDialog_Unable_to_find_Time_Tracking_preference;
    ...
    private String getTimeSpentTooltipText(final String wdhmTime) {
