...
public class Messages extends NLS {
    private static final String BUNDLE_NAME = "me.glindholm.connector.eclipse.internal.jira.ui.wizards.messages"; //$NON-NLS-1$
    ...
    public static String JiraRepositorySettingsPage_LabelToken;
